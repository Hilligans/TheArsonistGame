...
public interface IEntity {
    ...
    default void addPosition(double dx, double dy, double dz) {
    ...
    default void encode(IByteArray array) {
        array.writeFloat((float)getX());
        array.writeFloat((float)getY());
        array.writeFloat((float)getZ());
    }
}
